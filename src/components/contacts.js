  ...
  render() {
    return (
      <div style={this.listStyle}>
        <p>
          <a href="" onClick={this.refreshListing}>
            Refresh Listing
          </a>
        </p>
        <ul className="list-group">
          {this.state.items.map((listitem) => (
            <li key={listitem.id} className="list-group-item">
              <span
                onClick={() => {
                  this.props.viewContact(listitem);
                }}
              >
                <i className="fa fa-user"></i> {listitem.name}
              </span>
              <span>{listitem.email ? " | " + listitem.email : ""}</span>
              <button
                onClick={() => {
                  this.props.editContact(listitem);
                }}
                className="btn btn-primart btn-sm float-right"
              >
                Edit
              </button>
            </li>
